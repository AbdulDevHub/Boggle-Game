...
public class BoggleStats {
    ...
    /**
     * set of words the players have found in a given round
     */
    private Set<String> humanWords = new HashSet<String>();
    ...
    public enum PlayerType {
        ...
        PlayerType(final String player) {
            this.player = player;
        }
    }
